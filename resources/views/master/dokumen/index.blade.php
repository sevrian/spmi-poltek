      ...
      <div class="col-lg-2 col-sm-4 col-xs-12" style="margin-bottom: 10px">
       ...
       <div class="col-md-12">
           ...
           <div class="white-box">
               ...
               <h3 class="box-title">Tabel Master Jenis Dokumen</h3> 
               <table id="data-table-dokumen" class="display" style="width:100%">

                  <thead>
                     <tr>
                        <th>No</th>
                        <th style="width:80%">Nama Jenis Dokumen</th>
                        <th>Action</th>
                     </tr>
                  </thead>
                  <tbody>
                     ...
                     <tr>
                        ...
                        <td>
                           <form action="{{ route('dokumen.destroy', $hasil->id )}}" method="POST">
                              @csrf
                              @method('delete')
                           <a href="{{ route('dokumen.edit', $hasil->id ) }}" class="btn btn-primary btn-sm">Edit</a>
